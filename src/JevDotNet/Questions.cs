...
namespace JevDotNet
{
    ...
    public sealed class Choice<T> : ChoiceQuestion<T>
    {
        /// <summary>Initializes a new instance of the <see cref="Choice{T}"/> class.</summary>
    ...
    /// reads naturally.
    /// </summary>
    public sealed class Score : ScoreQuestion
    {
    ...
    /// API reads naturally.
    /// </summary>
    public sealed class Noul : NoulQuestion
    {
        /// <summary>Initializes a new instance of the <see cref="Noul"/> class.</summary>
        /// <param name="id">The identifier that matches the question with its answer inside a batch.</param>
