...
/// <summary>
/// Serves as the base class for exceptions thrown by <see cref="Jev"/>.
/// </summary>
public class JevException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JevException"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JevException"/> class with an inner exception.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JevValidationException"/> class.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JevValidationException"/> class with an inner exception.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
    /// <param name="innerException">The exception that caused this exception.</param>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JevProtocolException"/> class.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JevProtocolException"/> class with an inner exception.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
    /// <param name="innerException">The exception that caused this exception.</param>
...
/// <summary>
/// Thrown when the Jev API returns an unsuccessful HTTP status code.
/// </summary>
public sealed class JevApiException : JevException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JevApiException"/> class.
    /// </summary>
