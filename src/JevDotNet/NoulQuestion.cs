...
namespace JevDotNet
{
    /// <summary>A noul (yes/no) question. The answer is the probability that the answer is yes.</summary>
    public class NoulQuestion : IQuestion<NoulAnswer>, IJevQuestion
    {
        /// <summary>Initializes a new instance of the <see cref="NoulQuestion"/> class.</summary>
        ...
        /// <summary>Gets the optional description of what a yes (value near 1) means.</summary>
        public string? TrueDescription { get; }

        /// <summary>Gets the optional description of what a no (value near 0) means.</summary>
        public string? FalseDescription { get; }

        string IJevQuestion.QuestionType => "noul";
