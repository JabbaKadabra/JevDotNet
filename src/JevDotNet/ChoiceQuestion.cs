...
public record ChoiceQuestion<T> : IQuestion<ChoiceAnswer<T>>, IJevQuestion, IChoiceQuestionLimits
{
    /// <summary>
...
/// </summary>
public record ChoiceQuestion : IQuestion<ChoiceAnswer<string>>, IJevQuestion
{
