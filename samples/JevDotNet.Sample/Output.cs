...
public static class Output
{
    ...
    {
        Console.WriteLine("JevDotNet sample - live calls against TypeSafe System One");
    ...
    {
        Console.WriteLine("Usage: dotnet run --project samples/JevDotNet.Sample [scenario]");
        Console.WriteLine();
        Console.WriteLine("Calls the live TypeSafe System One API and requires JEV_API_KEY.");
        Console.WriteLine("Set JEV_MODEL to override the default model.");
        Console.WriteLine();
    ...
    {
        Console.Error.WriteLine("JEV_API_KEY is not set. The sample calls the live TypeSafe API.");
        Console.Error.WriteLine();
        Console.Error.WriteLine("  export JEV_API_KEY=\"your-key\"");
        Console.Error.WriteLine("  dotnet run --project samples/JevDotNet.Sample");
        Console.Error.WriteLine();
        Console.Error.WriteLine("Optionally set JEV_MODEL to use a model other than the default.");
    }
}
